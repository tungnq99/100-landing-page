...
export default function Experience() {
    return (
        <section id="experience" className="py-24 px-4 md:px-8 max-w-7xl mx-auto bg-neutral-950">
                ...
                <div className="lg:col-span-8 space-y-24">
                    {EXPERIENCE.map((exp, index) => (
                        ...
                        >
                            ...
                            <h3 className="text-3xl font-heading font-medium text-neutral-200 mb-2 group-hover:text-white transition-colors">
                                {exp.company}
                            </h3>
                            <p className="text-xl text-neutral-400 mb-4">{exp.role}</p>
